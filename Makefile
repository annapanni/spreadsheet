...
SRCS = srcs/token.cpp srcs/sheet.cpp srcs/parser.cpp srcs/console.cpp \
srcs/expressions/cell.cpp srcs/expressions/range.cpp srcs/expressions/functions.cpp srcs/expressions/operators.cpp
OBJS = $(SRCS:.cpp=.o)
